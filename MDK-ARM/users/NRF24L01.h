...
//NRF2401接收片选信号
#define Clr_NRF24L01_RX_CE      HAL_GPIO_WritePin(GPIOD, SPI5CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CE      HAL_GPIO_WritePin(GPIOD, SPI5CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_RX_CSN     HAL_GPIO_WritePin(GPIOG, SPI5CSN_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CSN     HAL_GPIO_WritePin(GPIOG, SPI5CSN_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(GPIOD, SPI5IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(GPIOD, SPI5IRQ_Pin, GPIO_PIN_SET) 

#define READ_NRF24L01_RX_IRQ    HAL_GPIO_ReadPin(GPIOD, SPI5IRQ_Pin) 


//NRF2401发射片选信号
#define Clr_NRF24L01_TX_CE      HAL_GPIO_WritePin(GPIOF, SPI4CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CE      HAL_GPIO_WritePin(GPIOF, SPI4CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_TX_CSN     HAL_GPIO_WritePin(GPIOF, SPI4CSN_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CSN     HAL_GPIO_WritePin(GPIOF, SPI4CSN_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(GPIOD, SPI4IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(GPIOD, SPI4IRQ_Pin, GPIO_PIN_SET) 

#define READ_NRF24L01_TX_IRQ    HAL_GPIO_ReadPin(GPIOD, SPI4IRQ_Pin) 
